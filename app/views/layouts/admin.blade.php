...
<head>
    ...
    <!-- Page-Level CSS -->
    <link href="" rel="stylesheet" />
    {{ HTML::style('backend/assets/plugins/morris/morris-0.4.3.min.css') }}
   </head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
    ...
    {{ HTML::script('backend/assets/plugins/pace/pace.js') }}
    {{ HTML::script('backend/assets/scripts/siminta.js') }}
    {{ HTML::script('backend/assets/plugins/morris/raphael-2.1.0.min.js') }}
    {{ HTML::script('backend/assets/plugins/morris/morris.js') }}
    {{ HTML::script('backend/assets/scripts/dashboard-demo.js') }}
</body>
